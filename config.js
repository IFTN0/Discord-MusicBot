module.exports = {
	...
	adminId: "770278507334729728", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "ODY5MjA4OTExMTIxNjMzMzEw.GokMht.0ZH2DC2DJT9Wgq4scDXJ3jUINnH5WQnr-KunyA", //- Bot's Token
	clientId: process.env.clientId || "869208911121633310", //- ID of the bot
	clientSecret: process.env.clientSecret || "IKbgcoAGQz3i-PwKSWAcTv2yJe29m3Ag", //- Client Secret of the bot
	...
	Issues: "https://github.com/IFTN0/Discord-MusicBot/issues", //- Bug Report Link
	...
	cookieSecret: "ISSAM_FTN is epic", //- Cookie Secret
